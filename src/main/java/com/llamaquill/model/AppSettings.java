...
public record AppSettings(String ollamaUrl, String selectedModel, int contextLimit, int responseLength, int minStoryWindow,
        int storyCardLookback, int anPlacement)
{
    public static AppSettings defaults()
    {
        GenerationSettings defaults = GenerationSettings.defaults();
        return new AppSettings(OllamaClient.DEFAULT_HOST, OllamaClient.DEFAULT_MODEL, defaults.contextLimit(),
